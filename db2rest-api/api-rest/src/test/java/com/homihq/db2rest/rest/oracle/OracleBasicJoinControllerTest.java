...
class OracleBasicJoinControllerTest extends OracleBaseIntegrationTest {
    ...
    void testLeftJoin() throws Exception {
        mockMvc.perform(post(VERSION + "/oradb/USERS/_expand")
                ...
                .andExpect(jsonPath("$.data[1].AUID", equalTo(6)))
                .andExpect(jsonPath("$.data[1].APID", nullValue()))
                .andExpect(jsonPath("$.data[3].AUID", equalTo(4)))
    ...
    void testRightJoin() throws Exception {
        mockMvc.perform(post(VERSION + "/oradb/USERS/_expand")
                ...
                .andExpect(jsonPath("$.data[1].AUID", equalTo(7)))
                .andExpect(jsonPath("$.data[1].APID", equalTo(7)))
                .andExpect(jsonPath("$.data[1].USERNAME", nullValue()))
                .andExpect(jsonPath("$.data[1].FIRSTNAME", equalTo("Ivan")))

                .andExpect(jsonPath("$.data[3].AUID", equalTo(3)))
                .andExpect(jsonPath("$.data[3].APID", equalTo(2)))
                .andExpect(jsonPath("$.data[3].USERNAME", nullValue()))
                .andExpect(jsonPath("$.data[3].FIRSTNAME", equalTo("Tom")))
