...
class PgBasicJoinControllerTest extends PostgreSQLBaseIntegrationTest {
    ...
    void testRightJoin() throws Exception {
        mockMvc.perform(post(VERSION + "/pgsqldb/users/_expand")
                ...
                .andExpect(jsonPath("$.data[1].auid", equalTo(5)))
                .andExpect(jsonPath("$.data[1].apid", equalTo(4)))
                .andExpect(jsonPath("$.data[1].username", nullValue()))
                .andExpect(jsonPath("$.data[1].firstname", equalTo("Bill")))

                .andExpect(jsonPath("$.data[3].auid", equalTo(7)))
                .andExpect(jsonPath("$.data[3].apid", equalTo(7)))
                .andExpect(jsonPath("$.data[3].username", nullValue()))
                .andExpect(jsonPath("$.data[3].firstname", equalTo("Ivan")))
